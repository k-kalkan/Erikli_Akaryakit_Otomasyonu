...
namespace ErikliBenzin
{
    public partial class Form1 : Form
    {
        ...
        private void SatısYap_Click(object sender, EventArgs e)
        {
        ...
        private void FiyatGu_Click(object sender, EventArgs e)
        {
            try
            {
            ...
            try
            {
                F_lpg = F_lpg + (F_benzin95 * Convert.ToDouble(textBox10.Text) / 100);
        ...
        private void DepoGu_Click(object sender, EventArgs e)
        {
            try
            {
                E_benzin95 = Convert.ToDouble(textBox1.Text);
                if (1000 < D_benzin95 + E_benzin95 || E_benzin95 <= 0)
                    textBox1.Text = "Depo Sınırını Aştınız!";
                else
            ...
            {
                textBox1.Text = "Lütfen Rakam Giriniz!";
            ...
            try
            {
                ...
                if (1000 < D_benzin97 + E_benzin97 || E_benzin97 <= 0)
                    textBox2.Text = "Depo Sınırını Aştınız!";
                else
            ...
            {
                textBox2.Text = "Lütfen Rakam Giriniz!";
            ...
            try
            {
                ...
                if (1000 < D_dizel + E_dizel || E_dizel <= 0)
                    textBox3.Text = "Depo Sınırını Aştınız!";
                else
            ...
            {
                textBox3.Text = "Lütfen Rakam Giriniz!";
            ...
            try
            {
                ...
                if (1000 < D_eurodizel + E_eurodizel || E_eurodizel <= 0)
                    textBox4.Text = "Depo Sınırını Aştınız!";
                else
            ...
            {
                textBox4.Text = "Lütfen Rakam Giriniz!";
            ...
            try
            {
                ...
                if (1000 < D_lpg + E_lpg || E_lpg <= 0)
                    textBox5.Text = "Depo Sınırını Aştınız!";
                else
            ...
            {
                textBox5.Text = "Lütfen Rakam Giriniz!";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            String[] yakıt_turleri = {"Benzin (95)","Benzin (97)","Dizel","Euro Dizel"," Lpg" };
